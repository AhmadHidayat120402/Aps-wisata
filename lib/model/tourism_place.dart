...
var tourismPlaceList = [
  TourismPlace(
    ...
    imageUrls: [
      ...
      'assets/images/drink-lembang.jpg',
      'assets/images/house-lembang.jpg',
    ],
  ),
  TourismPlace(
    ...
    imageUrls: [
      ...
      'assets/images/bosscha-observatory.jpg',
      'assets/images/photo3.jpg',
    ],
  ),
  TourismPlace(
    ...
    imageUrls: [
      'assets/images/quotes-kota-bandung.jpg',
  ...
  TourismPlace(
    ...
    imageUrls: [
      ...
      'assets/images/geology-museum.jpg',
      'assets/images/museum-geologi.jpg',
    ],
  ),
  TourismPlace(
    ...
    imageUrls: [
      ...
      'assets/images/floating-market-bandung.jpg',
      'assets/images/rute.jpg',
    ],
  ),
  TourismPlace(
    name: 'Kawah Putih',
    ...
    imageUrls: [
      ...
      'assets/images/rocks-sticking-out-of.jpg',
      'assets/images/danauBiru.jpg',
    ],
  ),
  TourismPlace(
    name: 'Ranca Upas',
